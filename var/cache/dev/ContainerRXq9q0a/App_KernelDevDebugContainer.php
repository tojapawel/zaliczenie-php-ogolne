...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('YIe3Q9KesR', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\KategoriaRepository' => ['privates', 'App\\Repository\\KategoriaRepository', 'getKategoriaRepositoryService', true],
            'App\\Repository\\UserRepository' => ['privates', 'App\\Repository\\UserRepository', 'getUserRepositoryService', true],
            'App\\Repository\\ZgloszenieRepository' => ['privates', 'App\\Repository\\ZgloszenieRepository', 'getZgloszenieRepositoryService', true],
        ], [
            'App\\Repository\\KategoriaRepository' => '?',
            'App\\Repository\\UserRepository' => '?',
            'App\\Repository\\ZgloszenieRepository' => '?',
        ])));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('wS6vP6I6GY', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
